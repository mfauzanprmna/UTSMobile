...
class DatabaseHelper(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    companion object {
        ...
        const val COLUMN_TLP_HP = "telepon"
    ...
    fun addAlumni(nim: String, nama: String, tempatLahir: String, tanggalLahir: String, alamat: String, agama: String, telepon: String, tahunMasuk: String, pekerjaan: String, jabatan: String): Long {
        ...
        values.put(COLUMN_TLP_HP, telepon)
    ...
    fun updateAlumni(id: String, nim: String, nama: String, tempatLahir: String, tanggalLahir: String, alamat: String, agama: String, tlpHp: String, tahunMasuk: String, pekerjaan: String, jabatan: String): Int {
        val db = this.writableDatabase
        val values = ContentValues()
        values.put(COLUMN_NIM, nim)
        values.put(COLUMN_NAMA, nama)
